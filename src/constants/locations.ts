// Common countries and their major cities
export const countryOptions = [
  'United States', 'United Kingdom', 'Germany', 'France', 'Spain', 'Italy', 
  'Brazil', 'Argentina', 'Mexico', 'Canada', 'Australia', 'Netherlands',
  'Belgium', 'Portugal', 'Japan', 'South Korea', 'India', 'Nigeria',
  'South Africa', 'Egypt', 'Morocco', 'Ghana', 'Kenya', 'Sweden',
  'Norway', 'Denmark', 'Poland', 'Turkey', 'Russia', 'China'
];

export const cityOptions: Record<string, string[]> = {
  'United States': ['New York', 'Los Angeles', 'Chicago', 'Houston', 'Phoenix', 'Philadelphia', 'San Antonio', 'San Diego', 'Dallas', 'San Jose'],
  'United Kingdom': ['London', 'Birmingham', 'Manchester', 'Liverpool', 'Leeds', 'Sheffield', 'Bristol', 'Leicester', 'Coventry', 'Bradford'],
  ...
  'Spain': ['Madrid', 'Barcelona', 'Valencia', 'Seville', 'Bilbao', 'Málaga', 'Murcia', 'Las Palmas', 'Palma', 'Zaragoza'],
  ...
  'Portugal': ['Lisbon', 'Porto', 'Vila Nova de Gaia', 'Amadora', 'Braga', 'Funchal', 'Coimbra', 'Setúbal', 'Almada', 'Aveiro'],
  ...
  'South Africa': ['Cape Town', 'Johannesburg', 'Durban', 'Pretoria', 'Port Elizabeth', 'Bloemfontein', 'East London', 'Pietermaritzburg', 'Nelspruit', 'Kimberley'],
  ...
  'Ghana': ['Accra', 'Kumasi', 'Tamale', 'Cape Coast', 'Sekondi-Takoradi', 'Sunyani', 'Ho', 'Koforidua', 'Techiman', 'Obuasi'],
  'Kenya': ['Nairobi', 'Mombasa', 'Kisumu', 'Nakuru', 'Eldoret', 'Kitale', 'Malindi', 'Garissa', 'Kakamega', 'Nyeri'],
